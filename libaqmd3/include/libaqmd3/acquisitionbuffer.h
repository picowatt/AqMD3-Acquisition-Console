...
namespace aqmd3
{
	...
	public:
		AcquisitionBuffer(uint64_t max_triggers_per_read, uint64_t samples_per_trigger)
			: data(max_triggers_per_read * samples_per_trigger), acquired_index(0), processed_index(0), offset(0), max_triggers_per_read(max_triggers_per_read), samples_per_trigger(samples_per_trigger)
		{
		}

		AcquisitionBuffer(size_t size)
			: data(size), acquired_index(0), processed_index(0), offset(0), max_triggers_per_read(0), samples_per_trigger(0)
		{
		}
